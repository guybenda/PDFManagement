...
const SELECT_TEST = [{id:1,title:'ניסיון 1'},{id:2,title:'ניסיון 2'},{id:3,title:'ניסיון 3'}];

export const UNITS = [
	{id:1,name:"קבוצה א",forms:[{id:0,name:'דו"ח חודשי 917'},{id:1,name:'דו"ח חודשי 916'},{id:2,name:'דו"ח חודשי 915'}]},
